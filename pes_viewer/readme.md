...
- the displayed Cartesian geometry $\mathbf R(q_1,q_2)$,
...
(q_1,q_2) \mapsto
\left[
E,\; \nabla E,\; \mathbf H,\; \mathbf H_{\mathrm{mw}},\; \mathbf R,\; \mathbf J
\right].
$$
...
$$
\mathbf H_{\mathrm{mw}} = \mathbf M^{-1/2} \, \mathbf H \, \mathbf M^{-1/2}.
$$
...
$$
\mathbf R(q_1,q_2) = \{ \mathbf R_a(q_1,q_2) \}_{a=1}^{N_{\mathrm{atoms}}}.
$$

For each atom $a$, each geometry is a 3-vector

$$
\mathbf R_a = (R_{a,x}, R_{a,y}, R_{a,z}).
$$
...
- `reduced_coordinate_index = 0` means $\partial \mathbf R / \partial q_1$
- `reduced_coordinate_index = 1` means $\partial \mathbf R / \partial q_2$
...
$$
\Delta \mathbf R_a
= \frac{\partial \mathbf R_a}{\partial q_1} u_1
+ \frac{\partial \mathbf R_a}{\partial q_2} u_2.
$$
